...
<head>
    ...
    <link rel="stylesheet" href="cssa/removebooks.css">
...
<body>
    ...
    <div class="container">
     ...
     ?>
            ...
            <div class="book">
                <form action="removebooksdb.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" value="<?php echo $row['imagepath'] ?>" style="display: none;"
                        name="oldimagepath">
